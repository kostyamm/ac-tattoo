        ...
        <SheetPortal>
            ...
            <SheetPrimitive.Content
                ...
                className={cn(
                    ...
                    "bg-background/95 supports-backdrop-filter:bg-background/70 supports-backdrop-filter:backdrop-blur-xl",
                    "border-border/70 shadow-2xl",

                    "data-[side=right]:inset-y-0 data-[side=right]:right-0 data-[side=right]:w-[88vw] data-[side=right]:max-w-[420px] data-[side=right]:border-l",
                    "data-[side=left]:inset-y-0 data-[side=left]:left-0 data-[side=left]:w-[88vw] data-[side=left]:max-w-[420px] data-[side=left]:border-r",
                ...
                {showCloseButton && (
                    <SheetPrimitive.Close data-slot="sheet-close" asChild>
                        <Button
                            ...
                            className="absolute right-8 top-6 rounded-full"
                        >
...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
          "flex flex-col gap-1.5 p-6 pr-20",
          className
      )}      {...props}
    />
  )
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn("text-base font-medium text-foreground leading-none pt-2", className)}
      {...props}
    />
  )
}
